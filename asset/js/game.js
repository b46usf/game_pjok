window.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("shootBtn").addEventListener("click", () => {
    if (!isKicked) {
      isKicked = true;
      velocity.set(0, 0.1, -0.4); // Tendang lurus ke depan
    }
  });
  ...
  function animate() {
    ...
    if (!isKicked) {
      ...
      velocity.y -= 0.008; // gravitasi sederhana
    }
